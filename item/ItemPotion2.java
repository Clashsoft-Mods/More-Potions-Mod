...
import clashsoft.mods.morepotions.brewing.PotionUtils;
...
public class ItemPotion2 extends Item
{
    ...
    {
        return par0Str.equals("bottle_drinkable") ? MorePotionsMod.potion2.bottle : (par0Str.equals("bottle_splash") ? MorePotionsMod.potion2.splashbottle : (par0Str.equals("overlay") ? MorePotionsMod.potion2.liquid : null));
    }
