...
public class MPMPotionList
{
	...
	public static void initializePotionBases()
	{
		...
		clear = new PotionBase("clear", clashsoft.mods.morepotions.MorePotionsMod.dustClay);
	...
	public static void initializePotionTypes()
	{
		...
		digSpeed = new PotionType(new PotionEffect(Potion.digSpeed.id, 20 * 180, 0), 7, 20 * 360, PotionList.digSlowdown, clashsoft.mods.morepotions.MorePotionsMod.dustGold, PotionType.getBaseBrewing(PotionList.dashing));
		...
		doubleLife = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.doubleLife.id, 1625000, 0), 0, 0, PotionList.harm, clashsoft.mods.morepotions.MorePotionsMod.dustNetherstar, PotionType.getBaseBrewing(PotionList.thick));
		...
		resistance = new PotionType(new PotionEffect(Potion.resistance.id, 20 * 180, 0), 3, 20 * 240, clashsoft.mods.morepotions.MorePotionsMod.dustDiamond, PotionType.getBaseBrewing(PotionList.thick));
		ironSkin = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.ironSkin.id, 20 * 120, 0), 1, 20 * 240, clashsoft.mods.morepotions.MorePotionsMod.dustIron, PotionType.getBaseBrewing(PotionList.thick));
		obsidianSkin = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.obsidianSkin.id, 20 * 120, 0), 1, 20 * 240, clashsoft.mods.morepotions.MorePotionsMod.dustObsidian, PotionType.getBaseBrewing(PotionList.thick));
		...
		waterWalking = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.waterWalking.id, 20 * 120, 0), 0, 240 * 20, PotionList.awkward);
		waterBreathing = new PotionType(new PotionEffect(Potion.waterBreathing.id, 20 * 180, 0), 2, 20 * 360, PotionList.waterWalking, clashsoft.mods.morepotions.MorePotionsMod.dustClay, PotionList.awkward);
		coldness = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.coldness.id, 20 * 180, 0), 1, 20 * 360, new ItemStack(Item.snowball), PotionList.awkward);
		...
		wither = new PotionType(new PotionEffect(Potion.wither.id, 450, 0), 1, 20 * 60, clashsoft.mods.morepotions.MorePotionsMod.dustWither, PotionType.getBaseBrewing(PotionList.acrid));
		explosiveness = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.explosiveness.id, 20 * 10, 0), 4, 20 * 20, PotionList.awkward);
		fire = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.fire.id, 20 * 10, 0), 0, 20 * 20, PotionList.explosiveness, new ItemStack(Item.fireballCharge), PotionList.awkward);
		random = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.random.id, clashsoft.mods.morepotions.MorePotionsMod.randomMode == 0 ? 1 : 20 * 45, 0), 0, clashsoft.mods.morepotions.MorePotionsMod.randomMode == 0 ? 1 : 20 * 90, PotionList.awkward);
		effectRemove = new PotionType(new PotionEffect(clashsoft.mods.morepotions.MorePotionsMod.effectRemove.id, 20 * 45, 0), 0, 20 * 90, PotionList.random, new ItemStack(Item.bucketMilk), PotionList.awkward);
