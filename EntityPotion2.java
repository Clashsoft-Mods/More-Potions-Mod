...
public class EntityPotion2 extends EntityPotion
{
    ...
    public EntityPotion2(World par1World, EntityLiving par2EntityLiving, ItemStack par3ItemStack)
    {
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        ...
        {
            List var2 = MorePotionsMod.potion2.getEffects(this.potionDamage);
                ...
                if (var4 != null && !var4.isEmpty())
                {
                    ...
                    while (var5.hasNext())
                    {
                        ...
                        if (var7 < 16.0D)
                        {
                            ...
                            while (var11.hasNext())
                            {
                                Brewing var12 = (Brewing)var11.next();
                                if (var12.getEffect() != null && var12.getEffect().getPotionID() > 0)
                                {
                                	int var13 = var12.getEffect().getPotionID();

                                	if (Potion.potionTypes[var13].isInstant())
                                	{
                                		Potion.potionTypes[var13].affectEntity(this.getThrower(), var6, var12.getEffect().getAmplifier(), var9);
                                	}
                                	else
                                	{
                                		int var14 = (int)(var9 * (double)var12.getEffect().getDuration() + 0.5D);

                                		if (var14 > 20)
                                		{
                                			var6.addPotionEffect(new PotionEffect(var13, var14, var12.getEffect().getAmplifier()));
                                		}
                                	}
                                }
                            }
    ...
    {
    	MorePotionsMod.proxy.playSplashEffect(this.worldObj, par1, par2, par3, par4ItemStack);
