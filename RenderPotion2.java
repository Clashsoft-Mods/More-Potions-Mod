...
public class RenderPotion2 extends Render
{
    ...
    public RenderPotion2(Item par1, int par2)
    {
        this.field_94151_a = par1;
        this.field_94150_f = par2;
    }

    public RenderPotion2(Item par1)
    {
        this(par1, 0);
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        {
            this.itemIconIndex = MorePotionsMod.potion2.splash;
        }
        ...
        GL11.glPushMatrix();
        this.func_77026_a(tessellator, ItemPotion2.func_94589_d("potion_contents"));
        GL11.glPopMatrix();
